import { Kn as ref, Nn as getCurrentScope, Qn as toRef, U as computed, Ut as provide, Vn as onScopeDispose, Yn as shallowRef, _n as watchEffect, gn as watch, xt as inject } from "./vue.runtime.esm-bundler-CJPQuahF.js";
import { J as padEnd, N as has, W as mergeDeep, _ as clamp, at as SUPPORTS_MATCH_MEDIA, c as getCurrentInstance, ct as consoleWarn, g as chunk, lt as deprecate, nt as IN_BROWSER, rt as PREFERS_REDUCED_MOTION, u as propsFactory, y as createRange } from "./defineComponent-oAmsGLkd.js";
...
function createTheme(options) {
	...
	function change(themeName, transition) {
		...
		if (transitionOptions) withPageTransition(apply, transitionOptions);
		else apply();
	}
	function cycle(themeArray = themeNames.value, transition) {
		const currentIndex = themeArray.indexOf(name.value);
		change(themeArray[currentIndex === -1 ? 0 : (currentIndex + 1) % themeArray.length], transition);
	}
...
//#endregion
export { useTheme as a, isParsableColor as c, getElementBox as d, getOverflow as f, provideTheme as i, parseColor as l, createTheme as n, hasLightForeground as o, getTargetBox as p, makeThemeProps as r, isCssColor as s, ThemeSymbol as t, Box as u };

//# sourceMappingURL=theme-DyW4Xbe1.js.map